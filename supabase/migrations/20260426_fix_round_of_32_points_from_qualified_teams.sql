-- =============================================================================
-- Fix scoring for knockout qualification points by round.
-- All knockout round buckets must score by qualified teams in each stage slots
-- (predicted vs actual), not by winners of matches in that same stage.
-- =============================================================================
...
BEGIN
  ...
  -- 2) Group position points: usar group_standings y exigir grupo completo
  ...
  -- Dieciseisavos: 10 points per correctly predicted qualified team in R32 slots.
  ...
  -- Octavos: 20 points per correctly predicted qualified team in R16 slots.
  ...
  -- Cuartos: 35 points per correctly predicted qualified team in QF slots.
  ...
  -- Semifinales: 50 points per correctly predicted qualified team in SF slots.
  ...
  -- 4) Finalist points (100 per correctly predicted team qualified to final slots)
