-- Honor 103/104: goles del pronostico con pred_home/pred_away, no equipos oficiales del partido.
...
COMMENT ON FUNCTION public.calculate_user_score(UUID) IS
  'Read-only w.r.t. predictions: reads prediction_* vs official matches/real_results, upserts only user_scores. Honor 103/104 uses pred team slots.';
