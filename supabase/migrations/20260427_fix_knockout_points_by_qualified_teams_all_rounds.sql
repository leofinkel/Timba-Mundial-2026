-- =============================================================================
-- Fix knockout scoring by qualified teams in bracket slots for all rounds.
-- This migration supersedes previous versions that used winner_team_id for
-- round scoring and restores rules-based points by qualified teams:
-- round-of-32 (10), round-of-16 (20), quarter-finals (35), semi-finals (50),
-- and final slots as finalists (100).
-- =============================================================================
