-- =============================================================================
-- Timba Mundial 2026 — Puntos por posición de grupo solo con tabla del admin
--
-- Sin partidos de grupo jugados, public.group_standings igual devuelve 4 filas
-- por grupo (0 pts, desempate alfabético). Eso hacía coincidencias espurias
-- con prediction_group_standings y puntajes > 0 sin resultados.
--
-- Solo se suman puntos por posición cuando el admin guardó el 1–4 definitivo
-- en real_group_standings (4 filas por ese group_id), igual que la vista activa
-- el override. No basta con tener partidos cargados.
-- =============================================================================
...
BEGIN
  ...
  -- 2) Group position points: solo si el admin guardó las 4 posiciones (override)
