-- =============================================================================
-- Timba Mundial 2026 — Goleador y figura en calculate_user_score
--
-- Compara predicción vs real_results sin distinguir mayúsculas/minúsculas
-- (lower), con trim y colapsando espacios internos, alineado con la app
-- (normalizeSpecialPredictionPlayerName).
--
-- Reemplaza la función completa con la misma lógica que deploy-all (versión
-- compacta); ejecutá con: supabase db push / migration run / SQL Editor.
-- =============================================================================
